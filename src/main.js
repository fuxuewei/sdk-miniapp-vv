...
var browserInfo = function browserInfo() {
  ...
  for (var k in browserArray) {
    if (browserArray[k]) {
      ...
      if (k === 'IE') {
        versions =
          ((_a = UserAgent.match(/(msie\s|trident.*rv:)([\w.]+)/)) === null ||
          _a === void 0
            ? void 0
            : _a[2]) || '';
      } else if (k === 'Chrome') {
        ...
        versions =
          ((_b = UserAgent.match(/chrome\/([\d.]+)/)) === null || _b === void 0
            ? void 0
            : _b[1]) || '';
      } else if (k === 'Firefox') {
        versions =
          ((_c = UserAgent.match(/firefox\/([\d.]+)/)) === null || _c === void 0
            ? void 0
            : _c[1]) || '';
      } else if (k === 'Opera') {
        versions =
          ((_d = UserAgent.match(/opera\/([\d.]+)/)) === null || _d === void 0
            ? void 0
            : _d[1]) || '';
      } else if (k === 'Safari') {
        versions =
          ((_e = UserAgent.match(/version\/([\d.]+)/)) === null || _e === void 0
            ? void 0
            : _e[1]) || '';
      } else if (k === 'Edge') {
        versions =
          ((_f = UserAgent.match(/edge\/([\d.]+)/)) === null || _f === void 0
            ? void 0
            : _f[1]) || '';
      } else if (k === 'QQBrowser') {
        versions =
          ((_g = UserAgent.match(/qqbrowser\/([\d.]+)/)) === null ||
          _g === void 0
            ? void 0
            : _g[1]) || '';
      }
...
var map =
  ((_a = {}),
  (_a[EPlatform.web] = WebTracer),
  (_a[EPlatform.wx] = WxTracer),
  (_a[EPlatform.tt] = TtTracer),
  _a);
var platform = getPlatform();
var TezignTracer = platform ? map[platform] || UnknownTracer : UnknownTracer;

export { TezignTracer as default };
